{if $tsptbg_product_addon_fields}
<fieldset>
	{include file="common_templates/subheader.tpl" title=$lang.tsp_the_bug_genie_for_cscart}
	
	{foreach from=$tsptbg_product_addon_fields item="field"}
